...
# Use for CUHK03 dataset
_C.DATASETS.LABELED = True

_C.DATASETS.DEST = "msmt17"
...
_C.SOLVER.USE_CENTER_LOSS = True
...
_C.SOLVER.USE_XENT_LOSS = True
_C.SOLVER.XENT_LOSS_WEIGHT = 1.0
# Weight of contrastive loss on query vectors
_C.SOLVER.USE_CONTRASTIVE_LOSS = True
_C.SOLVER.CONTRASTIVE_LOSS_WEIGHT = 1.0
# Weight of contrastive loss on centroids-query vectors
_C.SOLVER.USE_CENTROID_CONTRASTIVE_LOSS = True
_C.SOLVER.CENTROID_CONTRASTIVE_WEIGHT = 1.0

# # Weight of focal loss on query vectors
# _C.SOLVER.USE_FOCAL_LOSS = False
# _C.SOLVER.FOCAL_LOSS_WEIGHT = 0.0

# Whether to use automatic Python Lightning optimization
_C.SOLVER.USE_AUTOMATIC_OPTIM = False

# Supcon of Sup contrastive loss
_C.SOLVER.USE_SUPERVISED_CONTRASTIVE_LOSS = True
_C.SOLVER.SUPERVISED_CONTRASTIVE_LOSS_WEIGHT = 0.1
